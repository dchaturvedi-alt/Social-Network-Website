...
<body>
	...
	<h1>Edit Post</h1>
	<form:form
		action="${pageContext.request.contextPath}/employee/updatePost"
		modelAttribute="editIndPost" method="GET">
		...
		<form:textarea path="postContent"
			value="${editIndPost.getPostContent()}" class="form-control" style="font-size: 15px;"/>
		<br>
		<br>
