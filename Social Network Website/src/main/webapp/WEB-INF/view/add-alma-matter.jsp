...
<body>
	...
	<h1 style="text-align:center;">Add new alma matter</h1>
	<form:form action="${pageContext.request.contextPath}/employee/saveAlmaMatter" 
				modelAttribute="almaMatter" method="POST">
				
		<form:hidden path="aId" />
		<form:hidden path="userId" />
		<label for="name" style="font-size:15px;">Name of Alma Matter</label>
		<form:input path="almaMatterName" id="name" style="font-size:15px;" class="form-control"/><br>
