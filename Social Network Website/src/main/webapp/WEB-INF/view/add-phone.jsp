...
<body>
	...
	<h1 style="text-align:center;">Current phone numbers</h1><br>
	
	<div class="list-group">
		<c:forEach var="tempPhone" items="${phoneNumbers}">
			<button type="button" class="list-group-item list-group-item-action"><p style="font-size:15px; font-weight:bold; text-align:center;"><c:out value="${tempPhone.getPhoneNumber()}" /></p></button>
			<br>
		</c:forEach>
	</div>
	...
	<input type="button" value="Add Phone Number"
					onclick="window.location.href='showFormForAddPhoneNumber'; return false;"
					class="btn btn-success btn-lg" style="font-size:15px;"/>
	<br><br>
