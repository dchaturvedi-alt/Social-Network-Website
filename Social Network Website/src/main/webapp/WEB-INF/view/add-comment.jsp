...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/employee/postComment"
		modelAttribute="newComment" method="GET">
		<form:hidden path="commentId"/>
		<form:hidden path="userId"/>
		<form:hidden path="postId"/>
		<form:hidden path="postAuthorId"/>
		<form:hidden path="commentDate"/>
		
		<form:textarea path="commentContent" class="form-control" style="font-size:13px;"/>
		
		<div style="margin-top: 10px" class="form-group">
			<div class="col-sm-6 controls">
				<button type="submit" class="btn btn-success" style="font-size:12px;">Post Comment</button>
			</div>
		</div>
	</form:form>
