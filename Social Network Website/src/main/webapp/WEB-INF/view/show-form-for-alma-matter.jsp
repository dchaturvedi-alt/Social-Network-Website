...
<head>
<title>Form for alma matter</title>
...
<body>
	...
	<h1 style="text-align:center;">Alma Matter</h1>
	<br>
	<p style="font-size:20px;">Current Alma Matters</p><br>
	
	<div class="list-group">
	<c:forEach var="tempAlmaMatter" items="${almaMatters}">
		<button type="button" class="list-group-item list-group-item-action"><p style="font-size:15px;"><c:out value="${tempAlmaMatter.getAlmaMatterName()}"/></p></button>
	</c:forEach>
	</div>
	<br><br>
	<input type="button" value="Add Alma Matter"
					onclick="window.location.href='showFormForAddAlmaMatter'; return false;"
