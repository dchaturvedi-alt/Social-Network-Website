...
<body>
	...
	<h3>How would you like to describe your reaction on the post :</h3>
	<c:url var="liked" value="/employee/likeReaction">
		<c:param name="reaction" value="Liked" />
		<c:param name="postId" value="${indPost.getPostId()}" />
	</c:url>
	<c:url var="laughed" value="/employee/likeReaction">
		<c:param name="reaction" value="Laughed" />
		<c:param name="postId" value="${indPost.getPostId()}" />
	</c:url>
	<c:url var="cried" value="/employee/likeReaction">
		<c:param name="reaction" value="Cried" />
		<c:param name="postId" value="${indPost.getPostId()}" />
	</c:url>
	<c:url var="gotAngry" value="/employee/likeReaction">
		<c:param name="reaction" value="Got Angry" />
		<c:param name="postId" value="${indPost.getPostId()}" />
	</c:url>
	<a href="${liked}" style='font-size:50px;' class="button1">&#128522;</a> 
	<a href="${laughed}" style='font-size:50px;' class="button1">&#128514;</a>
	<a href="${cried}" style='font-size:50px;' class="button1">&#128557;</a>
	<a href="${gotAngry}" style='font-size:50px;' class="button1">&#128544;</a>
