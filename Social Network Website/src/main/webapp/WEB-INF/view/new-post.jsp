...
<body>
	...
	<h1 style="text-align: center; font-size:30px;">Share a new post</h1>
	<form:form action="${pageContext.request.contextPath}/employee/sharePost"
		modelAttribute="newPost" method="POST">
		
		<form:hidden path="postId" />
		
		<p style="font-size:20px;">Write Below</p>
		<form:textarea path="postContent" class="form-group form-control" rows="5" style="font-size:15px;"/>
		<br>
		<div style="margin-top: 10px" class="form-group">
			<div class="col-sm-6 controls">
				<button type="submit" class="btn btn-success btn-lg">Share</button>
			</div>
		</div>
	</form:form>
