...
<body>
	...
	<h1 style="text-align:center;">Welcome to update form</h1>

	<form:form
		action="${pageContext.request.contextPath}/employee/updateAbout"
		modelAttribute="about" method="POST">

		<form:hidden path="userId" />
			<label for="designation" style="font-size:15px;">Designation</label>
			<form:input path="designation" value="${about.getDesignation()}" class="form-control" id="designation" style="font-size:15px;"/>
		<br>
			<label for="aboutYou" style="font-size:15px;">About You</label>
			<form:input path="aboutYou" value="${about.getAboutYou()}" class="form-control" id="aboutYou" style="font-size:15px;"/>
		<br>
			<label for="relStatus" style="font-size:15px;">Relationship Status</label>
			<form:input path="relationshipStatus" value="${about.getRelationshipStatus()}" class="form-control" id="relStatus" style="font-size:15px;"/>
		<br>
		<div style="margin-top: 10px" class="form-group">
			<div class="col-sm-6 controls">
				<button type="submit" class="btn btn-success btn-lg" style="font-size:15px;">Update</button>
			</div>
		</div>
	</form:form>
