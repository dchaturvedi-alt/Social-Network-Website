...
<body>
				...
				<button class=" form-group btn btn-outline-success my-2 my-sm-0 btn-lg mx-5" type="submit">Logout</button>
							...
							<div class="col-xs-15">
								<div>
									...
									<c:if test="${phoneExists == 1}">

										<div class="alert alert-danger col-xs-offset-1 col-xs-10">
										<p style="font-size:20px; text-align:center;"><c:out value="Phone Number already exists"></c:out></p>
										</div>
										<br><br><br><br>
									</c:if>
									
									<c:if test="${phoneExists == 2}">

										<div class="alert alert-danger col-xs-offset-1 col-xs-10">
										<p style="font-size:20px; text-align:center;"><c:out value="Enter Valid Phone Number"></c:out></p>
										</div>
										<br><br><br><br>	
									</c:if>
								</div>
	...
	<h1 style="text-align:center;">Add phone number</h1>
	<form:form action="${pageContext.request.contextPath}/employee/savePhoneNumber" 
				modelAttribute="phonenumber" method="POST">
				
		<form:hidden path="phoneId" />
		<form:hidden path="userId" />
		<label for="phone" style="font-size:15px;"></label>
		<form:input path="phoneNumber" id="phone" class="form-control" style="font-size:15px;"/><br>
		<input type="submit" value="Save" class="btn btn-success btn-lg" style="font-size:15px;"/>
