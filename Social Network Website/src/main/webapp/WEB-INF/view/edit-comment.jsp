...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/employee/updateComment"
		modelAttribute="editComment" method="GET">
		...
		<form:textarea path="commentContent" class="form-control" style="font-size: 15px;"/>
		<br>
		<div style="margin-top: 10px" class="form-group">
			<div class="col-sm-6 controls">
				<button type="submit" class="btn btn-success" style="font-size: 15px;">Edit</button>
			</div>
		</div>
		<br>
	</form:form>
